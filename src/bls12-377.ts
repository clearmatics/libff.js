...
const bls12_377_fr_bytes = 1 * 32
const bls12_377_fq_bytes = 2 * 32
const bls12_377_g1_bytes = 2 * bls12_377_fq_bytes
const bls12_377_g2_bytes = 4 * bls12_377_fq_bytes

// TODO: Replace these with libff-node calls
function ecadd(pointA: Buffer, pointB: Buffer, output: Buffer): boolean {
...
function ecmul(point: Buffer, scalar: Buffer, output: Buffer): boolean {
